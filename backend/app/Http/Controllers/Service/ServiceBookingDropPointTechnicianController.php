...
class ServiceBookingDropPointTechnicianController extends Controller {
    /**
    ...
    public function show($id) {
        ...
        $record = ServiceBookingDropPointTechnician::where('id', $id)
            ->first();
    ...
    public function store(Request $request) {
        try {
            ...
            // create a new record
            $record = ServiceBookingDropPointTechnician::create($request->all());
    ...
    public function update(Request $request, $id) {
        try {
            // Find the record by ID
            $record = ServiceBookingDropPointTechnician::find($id);
