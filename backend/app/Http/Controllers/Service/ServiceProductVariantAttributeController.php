...
class ServiceProductVariantAttributeController extends Controller {
    /**
    ...
    public function show($id) {
        ...
        $record = ServiceProductVariantAttribute::where('id', $id)
            ->first();
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Create a new record
            $record = ServiceProductVariantAttribute::create($data);
    ...
    public function update(Request $request, $id)
    {
        try {
            // Find the record by ID
            $record = ServiceProductVariantAttribute::find($id);
