...
use App\Models\Service\ServiceVoucher;
...
class ServiceVoucherController extends Controller {
    ...
    public function show($id) {
        ...
        $record = ServiceVoucher::where('id', $id)
            ->first();
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $recordExists = ServiceVoucher::where('code', $request->input('code'))->exists();
            ...
            // Create a new record
            $record = ServiceVoucher::create($request->all());
