...
class ServiceBrandCategoryController extends Controller {
    /**
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $query = ServiceBrandCategory::query();
    ...
    public function show($id) {
        ...
        $record = ServiceBrandCategory::where('id', $id)
            ->first();
    ...
    public function store(Request $request) {
        try {
            // create a new record
            $record = ServiceBrandCategory::create($request->all());
    ...
    public function update(Request $request, $id) {
        try {
            // Find the record by ID
            $record = ServiceBrandCategory::find($id);
