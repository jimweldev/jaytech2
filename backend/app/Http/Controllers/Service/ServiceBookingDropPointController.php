...
class ServiceBookingDropPointController extends Controller {
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $query = ServiceBookingDropPoint::query();
    ...
    public function show($id) {
        ...
        $record = ServiceBookingDropPoint::where('id', $id)
            ->first();
    ...
    public function store(Request $request) {
        try {
            ...
            // create a new record
            $record = ServiceBookingDropPoint::create($request->all());
    ...
    public function update(Request $request, $id) {
        try {
            // Find the record by ID
            $record = ServiceBookingDropPoint::find($id);
