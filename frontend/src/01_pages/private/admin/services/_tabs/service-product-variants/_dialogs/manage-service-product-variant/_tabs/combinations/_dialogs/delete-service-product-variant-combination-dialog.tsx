...
// Component Props
type DeleteServiceProductVariantCombinationDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteServiceProductVariantCombinationDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteServiceProductVariantCombinationDialogProps) => {
  // Access store values
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            <h3 className="text-center text-xl">
              Delete ServiceProductVariantCombination
            </h3>
...
export default DeleteServiceProductVariantCombinationDialog;
