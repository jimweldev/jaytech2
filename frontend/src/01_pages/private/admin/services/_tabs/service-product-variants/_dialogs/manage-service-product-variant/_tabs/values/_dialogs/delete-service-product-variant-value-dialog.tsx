...
// Component Props
type DeleteServiceProductVariantValueDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteServiceProductVariantValueDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteServiceProductVariantValueDialogProps) => {
  // Access store values
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            <h3 className="text-center text-xl">
              Delete ServiceProductVariantValue
            </h3>
            ...
            <h2 className="text-center text-2xl font-semibold">
              {selectedServiceProductVariantValue?.value}
            </h2>
          </DialogBody>
...
export default DeleteServiceProductVariantValueDialog;
