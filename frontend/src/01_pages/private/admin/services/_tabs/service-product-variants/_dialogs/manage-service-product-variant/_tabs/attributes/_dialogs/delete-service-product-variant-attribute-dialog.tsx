...
// Component Props
type DeleteServiceProductVariantAttributeDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteServiceProductVariantAttributeDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteServiceProductVariantAttributeDialogProps) => {
  // Access store values
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            <h3 className="text-center text-xl">
              Delete ServiceProductVariantAttribute
            </h3>
            ...
            <h2 className="text-center text-2xl font-semibold">
              {selectedServiceProductVariantAttribute?.label}
            </h2>
          </DialogBody>
...
export default DeleteServiceProductVariantAttributeDialog;
