...
// Component Props
type CreateServiceProductVariantValueDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const CreateServiceProductVariantValueDialog = ({
  open,
  setOpen,
  refetch,
}: CreateServiceProductVariantValueDialogProps) => {
  ...
  const onSubmit = (data: z.infer<typeof FormSchema>) => {
    ...
    toast.promise(
      mainInstance.post(`/services/products/variants/values`, newData),
      {
        loading: 'Loading...',
        success: () => {
          form.reset();
      ...
      <DialogContent autoFocus={true}>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} autoComplete="off">
            {/* Dialog header */}
            <DialogHeader>
              <DialogTitle>Create ServiceProductVariantValue</DialogTitle>
            </DialogHeader>
...
export default CreateServiceProductVariantValueDialog;
