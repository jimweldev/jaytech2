...
// Component Props
type DeleteServiceProductDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteServiceProductDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteServiceProductDialogProps) => {
  // Access store values
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.promise(
      mainInstance.delete(`/services/products/${selectedServiceProduct?.id}`),
      {
        loading: 'Loading...',
        success: () => {
          refetch();
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Delete ServiceProduct</h3>
...
export default DeleteServiceProductDialog;
