...
// Component Props
type CreateServiceProductDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const CreateServiceProductDialog = ({
  open,
  setOpen,
  refetch,
}: CreateServiceProductDialogProps) => {
  ...
  const onSubmit = (data: z.infer<typeof FormSchema>) => {
    ...
    toast.promise(mainInstance.post(`/services/products`, newData), {
      loading: 'Loading...',
      success: () => {
        form.reset();
        refetch();
      ...
      <DialogContent autoFocus={true}>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} autoComplete="off">
            {/* Dialog header */}
            <DialogHeader>
              <DialogTitle>Create ServiceProduct</DialogTitle>
            </DialogHeader>
...
export default CreateServiceProductDialog;
