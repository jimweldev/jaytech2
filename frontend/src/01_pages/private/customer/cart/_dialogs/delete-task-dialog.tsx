...
// Component Props
type DeleteUserCartDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteUserCartDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteUserCartDialogProps) => {
  // Access store values
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit}>
          ...
          <DialogBody>
            ...
            {/* Modal title */}
            <h3 className="text-center text-xl">Delete UserCart</h3>
...
export default DeleteUserCartDialog;
